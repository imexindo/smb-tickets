...
<head>
    <title>403 | Smb Claim</title><!-- [Meta] -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('ablepro/dist/assets/fonts/inter/inter.css') }}" id="main-font-link">
    <!-- [phosphor Icons] https://phosphoricons.com/ -->
    <link rel="stylesheet" href="{{ asset('ablepro/dist/assets/fonts/phosphor/duotone/style.css') }}">
    <!-- [Tabler Icons] https://tablericons.com -->
    <link rel="stylesheet" href="{{ asset('ablepro/dist/assets/fonts/tabler-icons.min.css') }}"><!-- [Feather Icons] https://feathericons.com -->
    <link rel="stylesheet" href="{{ asset('ablepro/dist/assets/fonts/feather.css') }}">
    <!-- [Font Awesome Icons] https://fontawesome.com/icons -->
    <link rel="stylesheet" href="{{ asset('ablepro/dist/assets/fonts/fontawesome.css') }}">
    <!-- [Material Icons] https://fonts.google.com/icons -->
    <link rel="stylesheet" href="{{ asset('ablepro/dist/assets/fonts/material.css') }}"><!-- [Template CSS Files] -->
    ...
    <script async="" src="https://www.clarity.ms/tag/o2g7pzyzyz"></script>
    ...
    <script type="text/javascript">
        ...
        })(window, document, "clarity", "script", "o2g7pzyzyz");
    </script>
    <script defer="defer" src="https://phpstack-207002-5085356.cloudwaysapps.com/pixel/CDkpF1sQ8Tt5wpMZgqRvKpQiUhpWE3bc">
    </script>
    <link rel="stylesheet" href="{{ asset('ablepro/dist/assets/css/style-preset.css') }}">
    <link href="https://phpstack-207002-5085356.cloudwaysapps.com/themes/altum/assets/css/pixel.min.css" type="text/css"
        rel="stylesheet" media="screen,print">
</head><!-- [Head] end --><!-- [Body] Start -->

<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-layout="vertical" data-pc-direction="ltr"
    data-pc-theme_contrast="" data-pc-theme="light">
    <!-- [ Pre-loader ] start --><!-- [ Pre-loader ] End --><!-- [ Main Content ] start -->
                                ...
                                <div class="row justify-content-center align-items-center construction-card-bottom">
                                    <div class="col-md-6">
                                        <div class="text-center">
                                            <h1 class="mt-4"><b>Forbidden</b></h1>
                                            <p class="mt-4 text-muted">Maaf, Anda tidak memiliki akses ke halaman ini.</p><a
                                                href="/" class="btn btn-primary mb-3">Kembali Ke Beranda</a>
                                        </div>
                                    </div>
                                    <div class="col-md-6"><img class="img-fluid"
                                            src="https://ableproadmin.com/assets/images/pages/img-cunstruct-1.svg" alt="img"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    </div><!-- [ Main Content ] end --><!-- [ Main Content ] end --><!-- Required Js -->
    ...
    <script src="https://ableproadmin.com/assets/js/plugins/i18next.min.js"></script>
    <script src="https://ableproadmin.com/assets/js/plugins/i18nextHttpBackend.min.js"></script>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <symbol id="custom-facebook" viewBox="0 0 24 24">
                <path opacity="0.4"
                    ...
                    fill="currentcolor"></path>
                <path
                    d="M13.9205 9.2802L13.9705 12.2302L16.6005 12.1902C16.7905 12.1902 16.9305 12.3602 16.9005 12.5402L16.5504 14.4502C16.5204 14.5902 16.4005 14.6902 16.2605 14.7002L14.0105 14.7402L14.1305 21.9902L11.1305 22.0402L11.0105 14.7902L9.31046 14.8202C9.14046 14.8202 9.01047 14.6902 9.01047 14.5202L8.98047 12.6202C8.98047 12.4502 9.11046 12.3202 9.28046 12.3202L10.9805 12.2902L10.9305 9.0402C10.9005 7.3802 12.2205 6.0202 13.8805 5.9902L16.5804 5.9502C16.7504 5.9502 16.8805 6.0802 16.8805 6.2502L16.9205 8.6502C16.9205 8.8202 16.7905 8.9502 16.6205 8.9502L14.2205 8.9902C14.0505 8.9802 13.9205 9.1202 13.9205 9.2802Z"
                    fill="currentcolor"></path>
            </symbol>
            <symbol id="custom-google" viewBox="0 0 24 24">
                <path
                    d="M12.2 5.87C12.13 5.87 12.06 5.87 12 5.88V2.00999C12.07 1.99999 12.13 2 12.2 2C14.46 2 16.4 2.69 17.99 3.86C18.49 4.22 18.53 4.95 18.09 5.38L16.7 6.74001C16.36 7.07001 15.84 7.13 15.45 6.86C14.7 6.34 13.63 5.87 12.2 5.87Z"
                    fill="currentcolor"></path>
                <path
                    d="M21.8 12.2197C21.8 15.2697 20.71 17.8297 18.82 19.5797C17.17 21.1097 14.9 21.9997 12.2 21.9997C12.13 21.9997 12.07 21.9997 12 21.9897V18.1197C12.07 18.1297 12.13 18.1297 12.2 18.1297C13.69 18.1297 14.82 17.7197 15.67 17.1297C17 16.1997 17.6 14.8097 17.71 13.8897H13.2C12.65 13.8897 12.2 13.4397 12.2 12.8897V11.1797C12.2 10.6297 12.65 10.1797 13.2 10.1797H20.75C21.26 10.1797 21.69 10.5597 21.74 11.0697C21.78 11.4197 21.8 11.7897 21.8 12.2197Z"
                    fill="currentcolor"></path>
                <path opacity="0.4"
                    d="M6.49922 10.0198C6.29922 10.6398 6.17922 11.3098 6.17922 11.9998C6.17922 12.6898 6.29922 13.3498 6.50922 13.9798C7.28922 16.3298 9.44922 18.0398 11.9992 18.1198V21.9898C8.17922 21.9198 4.88922 19.6998 3.27922 16.4898H3.26922C2.58922 15.1298 2.19922 13.6098 2.19922 11.9998C2.19922 10.3898 2.58922 8.86977 3.26922 7.50977C4.87922 4.29977 8.16922 2.07977 11.9992 2.00977V5.87978C9.63922 5.94978 7.62922 7.40977 6.70922 9.47977C6.62922 9.65977 6.55922 9.83978 6.49922 10.0198Z"
                    fill="currentcolor"></path>
            </symbol>
            <symbol id="custom-github" viewBox="0 0 24 24">
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M8.99999 0.484131C4.39594 0.484131 0.666656 4.30849 0.666656 9.02993C0.666656 12.8071 3.05565 16.0072 6.36545 17.1403C6.77981 17.219 6.93328 16.9567 6.93328 16.7259C6.93328 16.5213 6.92817 15.9862 6.92305 15.2727C4.60568 15.7868 4.11458 14.1291 4.11458 14.1291C3.73602 13.1428 3.18865 12.8753 3.18865 12.8753C2.43154 12.3454 3.24493 12.3559 3.24493 12.3559C4.07877 12.4189 4.52383 13.2373 4.52383 13.2373C5.26559 14.5435 6.47288 14.1658 6.94863 13.9455C7.02536 13.3946 7.24022 13.0169 7.47554 12.8018C5.6288 12.592 3.68487 11.8575 3.68487 8.58402C3.68487 7.65022 4.00715 6.88955 4.54429 6.2915C4.45733 6.07116 4.17085 5.20557 4.62103 4.03045C4.62103 4.03045 5.32186 3.79963 6.91282 4.90654C7.57785 4.71768 8.28892 4.62326 8.99999 4.61801C9.70594 4.62326 10.4221 4.71768 11.0872 4.90654C12.6781 3.79963 13.379 4.03045 13.379 4.03045C13.8342 5.20557 13.5478 6.07641 13.4608 6.2915C13.9928 6.88955 14.3151 7.65022 14.3151 8.58402C14.3151 11.868 12.3661 12.5867 10.5091 12.8018C10.8058 13.0641 11.0769 13.5887 11.0769 14.3861C11.0769 15.5298 11.0667 16.4478 11.0667 16.7311C11.0667 16.9619 11.2151 17.2242 11.6396 17.1403C14.9494 16.0072 17.3333 12.8071 17.3333 9.03518C17.3333 4.30849 13.604 0.484131 8.99999 0.484131Z"
                    fill="currentcolor"></path>
            </symbol>
            ...
            <symbol id="custom-mask-1-outline" viewBox="0 0 24 24" fill="none">
                <path
                    d="M4.92999 19.82C4.72999 19.82 4.54002 19.74 4.40002 19.6C2.37002 17.57 1.25 14.87 1.25 12C1.25 6.07 6.07 1.25 12 1.25C14.87 1.25 17.57 2.37 19.6 4.4C19.74 4.54 19.82 4.73 19.82 4.93C19.82 5.13 19.74 5.32 19.6 5.46L5.46002 19.6C5.32002 19.74 5.12999 19.82 4.92999 19.82ZM12 2.75C6.9 2.75 2.75 6.9 2.75 12C2.75 14.22 3.53001 16.32 4.95001 17.99L17.99 4.95C16.32 3.53 14.22 2.75 12 2.75Z"
                    fill="currentcolor"></path>
                <path
                    d="M11.9997 22.7501C9.12969 22.7501 6.42972 21.6301 4.39972 19.6001C4.25972 19.4601 4.17969 19.2701 4.17969 19.0701C4.17969 18.8701 4.25972 18.6801 4.39972 18.5401L18.5397 4.40012C18.8297 4.11012 19.3097 4.11012 19.5997 4.40012C21.6297 6.43012 22.7497 9.13012 22.7497 12.0001C22.7497 17.9301 17.9297 22.7501 11.9997 22.7501ZM6.0097 19.0501C7.6797 20.4701 9.77969 21.2501 11.9997 21.2501C17.0997 21.2501 21.2497 17.1001 21.2497 12.0001C21.2497 9.78012 20.4697 7.68012 19.0497 6.01012L6.0097 19.0501Z"
                    fill="currentcolor"></path>
                <path
                    d="M13.4095 22.6502C13.2195 22.6502 13.0295 22.5802 12.8795 22.4302L7.21945 16.7702C6.92945 16.4802 6.92945 16.0002 7.21945 15.7102C7.50945 15.4202 7.98951 15.4202 8.27951 15.7102L13.9395 21.3702C14.2295 21.6602 14.2295 22.1402 13.9395 22.4302C13.7995 22.5802 13.6095 22.6502 13.4095 22.6502Z"
                    fill="currentcolor"></path>
                <path
                    d="M17.8705 20.0301C17.6805 20.0301 17.4905 19.9601 17.3405 19.8101L10.7605 13.2301C10.4705 12.9401 10.4705 12.4601 10.7605 12.1701C11.0505 11.8801 11.5305 11.8801 11.8205 12.1701L18.4005 18.7501C18.6905 19.0401 18.6905 19.5201 18.4005 19.8101C18.2505 19.9601 18.0605 20.0301 17.8705 20.0301Z"
                    fill="currentcolor"></path>
                <path
                    d="M21.1195 16.2201C20.9295 16.2201 20.7396 16.1501 20.5896 16.0001L14.2995 9.71011C14.0095 9.42011 14.0095 8.94012 14.2995 8.65012C14.5895 8.36012 15.0695 8.36012 15.3595 8.65012L21.6496 14.9401C21.9396 15.2301 21.9396 15.7101 21.6496 16.0001C21.5096 16.1401 21.3195 16.2201 21.1195 16.2201Z"
                    fill="currentcolor"></path>
            </symbol>
            ...
            <symbol id="custom-shield" viewBox="0 0 24 24">
                <path opacity="0.4"
                    ...
                    fill="currentcolor"></path>
                <path
                    d="M20.4103 11.1699V15.0199C20.4103 15.8299 19.8803 16.8799 19.2303 17.3699L13.7603 21.4599C13.2803 21.8199 12.6403 21.9999 12.0003 21.9999C11.3603 21.9999 10.7203 21.8199 10.2403 21.4599L8.32031 20.0299L20.4103 11.1699Z"
                    fill="currentcolor"></path>
            </symbol>
            ...
            <symbol id="custom-presentation-chart" viewBox="0 0 24 24">
                ...
                <path
                    ...
                    fill="currentcolor"></path>
                <path
                    d="M16.6703 22.34C16.5403 22.6 16.2703 22.75 16.0003 22.75C15.8903 22.75 15.7703 22.72 15.6703 22.67L12.0003 20.84L8.33025 22.67C8.23025 22.72 8.11027 22.75 8.00027 22.75C7.73027 22.75 7.46025 22.6 7.33025 22.34C7.14025 21.96 7.29028 21.51 7.67028 21.33L11.2503 19.54V17H12.7503V19.54L16.3303 21.33C16.7103 21.51 16.8603 21.96 16.6703 22.34Z"
                    fill="currentcolor"></path>
                <path
                    d="M7.5009 11.7499C7.2909 11.7499 7.07092 11.6599 6.92092 11.4799C6.65092 11.1599 6.70089 10.6899 7.02089 10.4199L10.1709 7.78993C10.4609 7.54993 10.8309 7.44994 11.1809 7.50994C11.5409 7.56994 11.8509 7.78991 12.0409 8.10991L13.0909 9.85991L16.0209 7.41994C16.3409 7.14994 16.8109 7.19992 17.0809 7.51992C17.3509 7.83992 17.3009 8.30991 16.9809 8.57991L13.8309 11.2099C13.5409 11.4499 13.1709 11.5499 12.8209 11.4899C12.4609 11.4299 12.1509 11.2099 11.9609 10.8899L10.9109 9.13994L7.98091 11.5799C7.84091 11.6899 7.6709 11.7499 7.5009 11.7499Z"
                    fill="currentcolor"></path>
            </symbol>
            ...
            <symbol id="custom-add-item" viewBox="0 0 24 24">
                ...
                <path
                    ...
                    fill="currentcolor"></path>
                <path
                    d="M18.1291 14.2501H17.2491V13.3701C17.2491 12.9601 16.9091 12.6201 16.4991 12.6201C16.0891 12.6201 15.7491 12.9601 15.7491 13.3701V14.2501H14.8691C14.4591 14.2501 14.1191 14.5901 14.1191 15.0001C14.1191 15.4101 14.4591 15.7501 14.8691 15.7501H15.7491V16.6301C15.7491 17.0401 16.0891 17.3801 16.4991 17.3801C16.9091 17.3801 17.2491 17.0401 17.2491 16.6301V15.7501H18.1291C18.5391 15.7501 18.8791 15.4101 18.8791 15.0001C18.8791 14.5901 18.5391 14.2501 18.1291 14.2501Z"
                    fill="currentcolor"></path>
            </symbol>

            <symbol id="custom-clipboard" viewBox="0 0 24 24">
                <path opacity="0.4"
                    d="M13.89 2.8799L9.19999 2.1399C5.28999 1.5299 3.47999 2.8499 2.85999 6.7599L2.11999 11.4499C1.71999 14.0099 2.13999 15.6699 3.58999 16.6799C4.34999 17.2199 5.38999 17.5799 6.73999 17.7899L11.43 18.5299C15.34 19.1399 17.15 17.8199 17.77 13.9099L18.5 9.2199C18.62 8.4499 18.67 7.7599 18.63 7.1499C18.5 4.6499 17.03 3.3699 13.89 2.8799ZM8.23999 9.3499C7.06999 9.3499 6.11999 8.3999 6.11999 7.2399C6.11999 6.0699 7.06999 5.1199 8.23999 5.1199C9.39999 5.1199 10.35 6.0699 10.35 7.2399C10.35 8.3999 9.39999 9.3499 8.23999 9.3499Z"
                    fill="currentcolor"></path>
                <path
                    d="M20.4998 13.4699L18.9998 17.9799C17.7498 21.7399 15.7498 22.7399 11.9898 21.4899L7.47984 19.9899C5.20984 19.2399 3.94984 18.1999 3.58984 16.6799C4.34984 17.2199 5.38984 17.5799 6.73984 17.7899L11.4298 18.5299C15.3398 19.1399 17.1498 17.8199 17.7698 13.9099L18.4998 9.2199C18.6198 8.4499 18.6698 7.7599 18.6298 7.1499C21.0198 8.4199 21.5398 10.3399 20.4998 13.4699Z"
                    fill="currentcolor"></path>
                <path
                    d="M10.3491 7.24012C10.3491 8.40012 9.39914 9.35012 8.23914 9.35012C7.06914 9.35012 6.11914 8.40012 6.11914 7.24012C6.11914 6.07012 7.06914 5.12012 8.23914 5.12012C9.39914 5.12012 10.3491 6.07012 10.3491 7.24012Z"
                    fill="currentcolor"></path>
            </symbol>
            ...
            <symbol id="custom-wallet-2" viewBox="0 0 24 24" fill="currentcolor" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.4" d="M13 9H7" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
    ...
    <script src="https://ableproadmin.com/assets/js/script.js"></script>
    <script src="https://ableproadmin.com/assets/js/theme.js"></script>
    <script src="https://ableproadmin.com/assets/js/multi-lang.js"></script>
